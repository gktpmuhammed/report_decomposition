...
if __name__ == "__main__":
    ...
    conc_json_file = "output/ct_rate/conc_info_manual_v5.json"
    conc_output_file = "output/ct_rate/patients_with_conclusion.txt"
    find_patients_with_key(conc_json_file, "Conclusion", conc_output_file)

    print("-" * 20)

    # Process descriptions/findings file
    desc_json_file = "output/ct_rate/desc_info_manual_v5.json"
    desc_output_file = "output/ct_rate/patients_with_findings.txt"
